...
// compute prime numbers and print on screen and then self destruct after certain amount of time 
...
// -lm in makefile links with mathlibrary 
...
int main(int argc, char *argv[]) {
	...
	pid_t pid;
	if ((pid = fork()) == 0) {
		// child process finds and displays priimes forever 
		unsigned long num = 2;
